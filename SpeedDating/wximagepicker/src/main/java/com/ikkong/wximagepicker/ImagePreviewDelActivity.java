...
public class ImagePreviewDelActivity extends ImageBaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleCount.setText(getString(R.string.get_image_count, mCurrentPosition + 1, selectedImages.size()));
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_del) {
            ...
            new android.support.v7.app.AlertDialog.Builder(this)
                    ...
                    .setMessage("Comfirm to delete image？")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(selectedImages.size() > 0){
                                ...
                                //刷新显示当前位置
                                //com.lzy.imagepicker.R.string.preview_image_count
                                mTitleCount.setText(getString(R.string.get_image_count, mCurrentPosition + 1, selectedImages.size()));
                            }
                            if(selectedImages.size() == 0){
                                onBackPressed();
